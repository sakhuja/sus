...
<?php
  ...
  if(isset($_GET['event']) && isset($_GET['location'])){
    ...
    $yql_query_url = "http://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20upcoming.events%20where%20location%3D%27San%20Francisco%27%20and
    %20search_text%3D%27music%27&diagnostics=true" . "&format=json";
    
    echo "query " . $yql_query_url;
    // Make call with cURL
